...
// Both SH8601 and CO5300 override displayOff/On to issue DISPOFF+SLPIN /
// DISPON+SLPOUT with the panel's settle delays — powers the controller down,
// not just brightness 0.
