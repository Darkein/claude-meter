...
//   BOOT (primary) — GPIO 9, cycles display brightness
//   PWR — AXP2101 PKEY IRQ, handled in power.cpp; hold ~3s + release = pairing
//   KEY (secondary) — GPIO 10, cycles notification-chime volume
